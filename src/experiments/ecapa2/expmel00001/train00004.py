...
cfg.ml.batch_size = 80
cfg.ml.num_workers = 8
cfg.ml.accumulate_grad_batches = 6 # batch_size * accumulate_grad_batches = 506 ~ 512
...
cfg.model.ecapa2.lfe_use_frequency_encoding = True # Falseでも性能良いかも
