...
IS_LOGGING = True
FAST_DEV_RUN = False
PRE_MODEL = "logs/ecapa2_mel_00022/ckpt/ckpt-18/ecapa2.ckpt"
...
cfg.ml.optimizer.lr = 3e-3 # ft: 1e-5
...
cfg.ml.optimizer.lr_min = 1e-5
cfg.ml.optimizer.t_initial = 50
cfg.ml.optimizer.warm_up_init = 1e-5 # pretrained modelの場合は0
cfg.ml.optimizer.warm_up_t = 1 # pretrained modelの場合は0
