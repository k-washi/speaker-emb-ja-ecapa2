...
from src.ecapa_tdnn.pl_model_ecapatdnn_mel3 import EcapaTDNNModelModule
...
cfg.ml.num_workers = 14
cfg.ml.accumulate_grad_batches = 1 # batch_size * accumulate_grad_batches = 506 ~ 512
...
# loss
cfg.model.mmas.focal_loss = False
cfg.model.mmas.focal_loss_gamma = 2
cfg.model.mmas.label_smoothing = 0
