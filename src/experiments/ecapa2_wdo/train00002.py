...
from src.ecapa2.pl_model_e2nextmel_m import Ecapa2ModelModule
from src.dataset.ecapa2.pl_dataset_mel3 import Ecapa2DatasetModule
...
cfg.ml.num_workers = 6
cfg.ml.accumulate_grad_batches = 35 # batch_size * accumulate_grad_batches = 506 ~ 512
...
cfg.model.ecapa2.local_feature_repeat_list =  [2, 3, 3, 4]
cfg.model.ecapa2.activation = "gelu"
cfg.model.ecapa2.speaker_emb_dim = 192
cfg.model.ecapa2.dropout_rate = 0.2
