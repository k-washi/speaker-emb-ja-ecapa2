# Speech brain like ecapa_tdnn model with classification head.
import traceback
...
from src.criteria.classifier_loss import ClassifierLoss
...
class EcapaTDNNModelModule(LightningModule):
    def __init__(
        ...
        self.ce_loss = ClassifierLoss(
            ...
            label_smoothing=mc.mmas.label_smoothing
        )
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss, _ = self.ce_loss(output, label1)
