...
class LocalFeatureExtractorModule(nn.Module):
    def __init__(
        ...
        fwse_hidden_dim: int = 128,
        use_frequency_encoding: bool = False,
        out_channels_list: list[int] = [164, 164, 164, 192, 192],
        stride_list: list[tuple[int, int]] = [(1, 1), (2, 1), (2, 1), (2, 1), (2, 1)],
        repeat_num_list: list[int] = [3, 4, 4, 4, 5]
    ):
        super().__init__()
...
class ECAPA2(nn.Module):
    def __init__(
        ...
        self.lfe = LocalFeatureExtractorModule(
            ...
            out_channels_list=[164, 164, 164, 192, 192],
            stride_list=[(1, 1), (2, 1), (2, 1), (2, 1), (2, 1)],
            repeat_num_list=[3, 4, 4, 4, 5]
        )
